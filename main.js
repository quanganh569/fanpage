...
var map = {
	...
	"./components/campaign/campaign.module": [
...
/* harmony import */ var _services_FANPAGE_data_service__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./services-FANPAGE/data.service */ "./src/app/services-FANPAGE/data.service.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _services_FANPAGE_data_service__WEBPACK_IMPORTED_MODULE_39__["DataService"],
                {
...
var PagesConfig = /** @class */ (function () {
    function PagesConfig() {
        ...
        this.config = {
            '/': {
                page: {
                    title: '--------TRUNG TÂM GIÁM SÁT AN TOÀN KHÔNG GIAN MẠNG QUỐC GIA--------',
...
var BarChartComponent = /** @class */ (function () {
    function BarChartComponent() {
        ...
        // tslint:disable-next-line:max-line-length
        this.barChartLabels = ['Tuần 1', 'Tuần 2 ', 'Tuần 3', 'Tuần 4', 'Tuần 5', 'Tuần 6', 'Tuần 7', 'Tuần 8', 'Tuần 9', 'Tuần 10', 'Tuần 11'];
...
/***/ "./src/app/services-FANPAGE/data.service.ts":
/*!**************************************************!*\
  !*** ./src/app/services-FANPAGE/data.service.ts ***!
  \**************************************************/
...
var DataService = /** @class */ (function () {
    function DataService(_http) {
        ...
        this.linkLikeApi = 'https://5cebbeb877d47900143b8ddc.mockapi.io/api/like';
        this.linkUpdateApi = 'https://5cebbeb877d47900143b8ddc.mockapi.io/api/like/';
        this.linkCreateApi = 'https://5cebbeb877d47900143b8ddc.mockapi.io/api/like';
        // Link API cho chiến dịch REVIEW
        this.linkReviewGetApi = 'https://5cebbeb877d47900143b8ddc.mockapi.io/api/review';
        this.linkReviewCreateApi = 'https://5cebbeb877d47900143b8ddc.mockapi.io/api/review';
        this.linkReviewUpdateApi = 'https://5cebbeb877d47900143b8ddc.mockapi.io/api/review/';
        // Link API cho chiến dịch SHARE
        this.linkShareGetApi = 'https://5cebbeb877d47900143b8ddc.mockapi.io/api/share';
        this.linkShareCreateApi = 'https://5cebbeb877d47900143b8ddc.mockapi.io/api/share';
        this.linkShareUpdateApi = 'https://5cebbeb877d47900143b8ddc.mockapi.io/api/share/';
        // API lấy dữ liệu biểu đồ cho DASHBOARD
        this.chartGetApi = 'https://5cebbeb877d47900143b8ddc.mockapi.io/api/chart';
        // API lấy dữ liệu web box cho DASHBOARD
        this.webBoxApi = 'https://5cf88dd5e3c79f001439ae93.mockapi.io/webbox/webbox';
    }
    // ----------LIKE CHIEN DICH------------------------
    DataService.prototype.getLike = function () {
        return this._http.get(this.linkLikeApi);
    };
    DataService.prototype.updateLike = function (id, update) {
        return this._http.put("" + this.linkUpdateApi + id, update);
    };
    DataService.prototype.detailLike = function (id) {
        return this._http.get("" + this.linkUpdateApi + id);
    };
    DataService.prototype.createLike = function (create) {
        return this._http.post(this.linkCreateApi, create);
    };
    // ----------REVIEW CHIEN DICH------------------------
    DataService.prototype.getReview = function () {
        return this._http.get(this.linkReviewGetApi);
    };
    DataService.prototype.createReview = function (create) {
        return this._http.post(this.linkReviewCreateApi, create);
    };
    DataService.prototype.updateReview = function (id, update) {
        return this._http.put("" + this.linkReviewUpdateApi + id, update);
    };
    DataService.prototype.detailReview = function (id) {
        return this._http.get("" + this.linkReviewUpdateApi + id);
    };
    // --------SHARE CHIEN DICH----------------
    DataService.prototype.getShare = function () {
        return this._http.get(this.linkShareGetApi);
    };
    DataService.prototype.createShare = function (create) {
        return this._http.post(this.linkShareCreateApi, create);
    };
    DataService.prototype.updateShare = function (id, update) {
        return this._http.put("" + this.linkShareUpdateApi + id, update);
    };
    DataService.prototype.detailShare = function (id) {
        return this._http.get("" + this.linkShareUpdateApi + id);
    };
    DataService.prototype.getChartData = function () {
        return this._http.get(this.chartGetApi);
    };
    DataService.prototype.getWebboxData = function () {
...
module.exports = __webpack_require__(/*! F:\ban-3-prj\src\main.ts */"./src/main.ts");
